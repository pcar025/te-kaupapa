...
describe.skipIf(!hasTestDatabaseUrl())('PostgreSQL migration upgrade', () => {
  it('upgrades the genuine 0000 through 0005 Drizzle journal through the current schema', async () => {
